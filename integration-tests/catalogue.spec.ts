...
test('go to catalogue page and select guided install', async ({ page }) => {
  await page.goto('/');
...
test('go to catalogue page and select a category', async ({ page }) => {
  await page.goto('/');
...
test('go to catalogue page, enter a search term, hit enter', async ({
  page,
}) => {
  await page.goto('/');
